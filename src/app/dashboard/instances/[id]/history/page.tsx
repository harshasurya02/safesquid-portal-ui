...
import { getInstanceDetailsServer, getInstanceHistoryServer } from "@/services/instance.service";
...
export default async function InstanceHistoryPage({ params, searchParams }: PageProps) {
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="pt-6 border-t border-gray-100">
                    <HistoryTable 
                        ...
                        pagination={historyResponse?.pagination || { page: 1, limit: 10, total: 0, totalPages: 1 }}
                    />
                </div>
            </div>
        </div>
